...
from constants import REGEX_WINDOW_MENU_FORM_NAME, REGEX_BUILD, REGEX_BUILD_ALT, CARRIER_DICT, CELLULAR_BUILDS, \
    SUFFIX_DICT, REGEX_RESOLUTION, SYTELINE_WINDOW_TITLE
